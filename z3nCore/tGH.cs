...
public class tGit
    {
        ...
        #region Constructors
        public tGit(IZennoPosterProjectModel project, string token, string username, string organization = null)
        {
        ...
        public tGit(IZennoPosterProjectModel project) : this(project, "", "", null)
        {
        ...
        public void Main(string baseDir, string token, string username, string commitMessage = "ts")
        {
            ...
            var tempGit = new tGit(_project, token, username);
